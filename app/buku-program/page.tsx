...
export default function ProgrammeBook() {
  return <main className="book-page">
    ...
    <ProgrammeBookReader />
    <section className="book-footer"><p>Simpan buku program untuk rujukan semasa Kemuncak.</p><a href="/media/buku-program-puice-2026.pdf" download>Muat Turun PDF ↓</a></section>
